              ...
              <ScrollArea className="h-[300px] pr-4">
                <div className="space-y-3">
                  <AnnouncementItem
                    ...
                    date="1 day ago"
                    content="The end semester examination schedule has been published. Please check the date sheet section for details."
                  />
                  <AnnouncementItem
                    title="Mid-Semester Results"
                    date="3 days ago"
                    content="Mid-semester examination results for Mathematics and Physics have been published."
                  />
                  <AnnouncementItem
                    title="Revaluation Process"
                    date="1 week ago"
                    content="The revaluation process for the previous semester has begun. Last date for application is October 30th."
                  />
                  <AnnouncementItem
                    title="CLAS Test Guidelines"
                    date="2 weeks ago"
                    content="New guidelines for the CLAS test have been published. Please read them carefully before your next test."
                  />
                </div>
              </ScrollArea>
            </CardContent>
